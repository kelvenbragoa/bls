            ...
            <div style="border-radius: 56px; padding: 0.3rem;">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        <router-link to="/">
                            <img src="/logo.png" class="mb-8 w-16 shrink-0 mx-auto" alt="">
                        </router-link>

                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">BLS - Barzilay Linguistic Services</div>
