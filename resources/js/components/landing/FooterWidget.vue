<template>
    <div class="py-6 px-6 mx-0 mt-20 lg:mx-20">
        ...
        <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20"></span>
                    ...
                    <h4 class="font-medium text-3xl text-surface-900 dark:text-surface-0">BLS</h4>
                </a>
            </div>
            ...
            <div class="col-span-12 md:col-span-10">
                <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                    <div class="col-span-12 md:col-span-3">
                        <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">Empresa</h4>
